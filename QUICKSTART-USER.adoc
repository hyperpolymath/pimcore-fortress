...
// Replace pimcore-fortress, Pimcore Fortress — See README.adoc for details., just run, Pimcore Fortress started successfully. with actuals
= pimcore-fortress — Quick Start for Users
:toc:
:toclevels: 2

== What is pimcore-fortress?

Pimcore Fortress — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./pimcore-fortress-portable
----
...
[source]
----
Pimcore Fortress started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/pimcore-fortress/wiki
