...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/pimcore-fortress/security/advisories/new)
...
- This repository (`hyperpolymath/pimcore-fortress`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/pimcore-fortress/security/advisories)
...
When using Pimcore Fortress, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/pimcore-fortress/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/pimcore-fortress/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/pimcore-fortress/discussions) |
...
*Thank you for helping keep Pimcore Fortress and its users safe.* 🛡️
