...
git clone <https://github.com/hyperpolymath/pimcore-fortress.git> cd
pimcore-fortress
...
toolbox create pimcore-fortress-dev toolbox enter pimcore-fortress-dev
...
pimcore-fortress/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
flake (Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/pimcore-fortress/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/pimcore-fortress/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/pimcore-fortress/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/pimcore-fortress/labels/perimeter-3) — Community sandbox scope
