{
  description = "pimcore-fortress - {project-description}";
    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in
      {
        ...
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            echo "🚀 pimcore-fortress development environment"
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P pimcore-fortress.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/pimcore-fortress $out/bin/  # Rust
            # cp bin/pimcore-fortress $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/pimcore-fortress";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-pimcore-fortress" {
